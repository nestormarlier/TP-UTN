# Generated by Django 2.2 on 2020-12-13 12:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delete', models.DateTimeField(blank=True, null=True, verbose_name='Fecha baja')),
            ],
            options={
                'db_table': 'impresora',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now=True, db_column='creado', verbose_name='Fecha de alta')),
                ('modified', models.DateTimeField(auto_now=True, db_column='modificado', verbose_name='Fecha modificado')),
                ('activo', models.BooleanField(default=True, verbose_name='Operario Activo')),
                ('delete', models.DateField(blank=True, null=True, verbose_name='Fecha baja')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parada', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='control.Parada', verbose_name='Parada')),
            ],
            options={
                'verbose_name': 'Setup',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ayudante1ero', models.ForeignKey(db_column='ayudante1er', on_delete=django.db.models.deletion.DO_NOTHING, related_name='ayudante1er', to='control.Operario', verbose_name='Primer ayudante')),
                ('ayudante2do', models.ForeignKey(db_column='ayudante2do', on_delete=django.db.models.deletion.DO_NOTHING, related_name='ayudante2do', to='control.Operario', verbose_name='Segundo ayudante')),
                ('cambio', models.ManyToManyField(blank=True, db_column='cambio_id', related_name='cambio', to='control.CambioMecanico', verbose_name='Cambio Mecánico')),
                ('fichaTecnica', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='control.FichaTecnica')),
                ('impresora', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='control.Impresora')),
                ('maquinista', models.ForeignKey(db_column='maquinista', on_delete=django.db.models.deletion.DO_NOTHING, related_name='maquinista', to='control.Operario', verbose_name='Maquinista')),
                ('produccion', models.ManyToManyField(blank=True, db_column='produccion', related_name='produccion', to='control.Produccion', verbose_name='Producción')),
                ('setup', models.ManyToManyField(blank=True, db_column='setup', related_name='setup', to='control.Setup', verbose_name='RM AC AP')),
                ('supervisor', models.ForeignKey(db_column='supervisor', on_delete=django.db.models.deletion.DO_NOTHING, related_name='supervisor', to='control.Operario', verbose_name='Supervisor')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='parada',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='control.Parada', verbose_name='Parada'),
        ),
    ]
