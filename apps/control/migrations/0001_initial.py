# Generated by Django 3.0.5 on 2021-03-24 13:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('observacion_gral', models.ManyToManyField(blank=True, db_column='obs_gles', related_name='observacion_gral', to='control.ObservacionesGles', verbose_name='Observaciones generales')),
                ('observacion_mant', models.ManyToManyField(blank=True, db_column='obs_mant', related_name='observacion_mant', to='control.ObsMantenimiento', verbose_name='Observaciones de mantenimiento')),
